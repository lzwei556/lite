...
type DisplayPropertyGroup = `feature.property.group.${
  | 'core'
  | 'time-domain'
  | 'frequency'
  | 'statistics'
...
export const VELOCITY_RMS: DisplayProperty = {
  ...
  first: true,
  unit: 'mm/s',
  group: 'feature.property.group.core'
};
...
export const ACCELERATION_RMS: DisplayProperty = {
  ...
  precision: 3,
  unit: 'm/s²',
  group: 'feature.property.group.time-domain'
};
...
const CREST_FACTOR: DisplayProperty = {
  ...
  precision: 3,
  group: 'feature.property.group.statistics'
};
...
const HALF_HARMONIC: DisplayProperty = {
  ...
  precision: 3,
  unit: 'm/s²',
  group: 'feature.property.group.frequency'
};
...
const SVT210 = [
  ...
  { ...TEMPERATURE, group: 'feature.property.group.core' as DisplayPropertyGroup },
  FREQUENCY,
  ACCELERATION_RMS,
  ACCLERATION_PEAK,
  DISPLACEMENT_RMS,
  ...
  MARGIN_FACTOR,
  VARIANCE,
  { ...INCLINATION, group: 'feature.property.group.skew' as DisplayPropertyGroup },
  { ...PITCH, group: 'feature.property.group.skew' as DisplayPropertyGroup },
  { ...ROLL, group: 'feature.property.group.skew' as DisplayPropertyGroup }
];
      ...
      fields: [
        {
          ...
          key: 'temperature',
          dataIndex: 1,
          alias: 'corrosion.contact.temperature'
        },
        {
          name: 'FIELD_ENVIRONMENT_TEMPERATURE',
          key: 'env_temperature',
          dataIndex: 3,
          alias: 'corrosion.rod-top.temperature'
        }
      ]
    },
    CORROSION_LOSS,
