...
export const SENSOR_DISPLAY_PROPERTIES = {
  [DeviceType.SA]: FeatureData.CATEGORIES.SA,
  [DeviceType.SA_S]: FeatureData.CATEGORIES.SA,
  [DeviceType.SAS]: FeatureData.CATEGORIES.SAS,
  [DeviceType.SASLoraWAN]: FeatureData.CATEGORIES.SAS,
  [DeviceType.SAS120D]: FeatureData.CATEGORIES.SAS,
  [DeviceType.SAS120Q]: FeatureData.CATEGORIES.SAS,
  [DeviceType.DS4]: FeatureData.CATEGORIES.DS,
  [DeviceType.DS8]: FeatureData.CATEGORIES.DS,
  [DeviceType.DC110]: FeatureData.CATEGORIES.DC_NORMAL,
  [DeviceType.DC110C]: FeatureData.CATEGORIES.DC_NORMAL,
  [DeviceType.DC110L]: FeatureData.CATEGORIES.DC_NORMAL,
  [DeviceType.DC110H]: FeatureData.CATEGORIES.DC_HIGH,
  [DeviceType.DC110HC]: FeatureData.CATEGORIES.DC_HIGH,
  [DeviceType.DC110HL]: FeatureData.CATEGORIES.DC_HIGH,
  [DeviceType.DC210L]: FeatureData.CATEGORIES.DC_Ultra_HIGH,
  [DeviceType.DC210]: FeatureData.CATEGORIES.DC_Ultra_HIGH,
  [DeviceType.DC210C]: FeatureData.CATEGORIES.DC_Ultra_HIGH,
  [DeviceType.SVT220520P]: FeatureData.CATEGORIES.SVT220520P,
  [DeviceType.SVT520C]: FeatureData.CATEGORIES.SVT220520P,
  [DeviceType.SVT210510P]: FeatureData.CATEGORIES.SVT210510P,
  [DeviceType.SVT510C]: FeatureData.CATEGORIES.SVT210510P,
  [DeviceType.SVT210K]: FeatureData.CATEGORIES.SVT210K,
  [DeviceType.SVT210A]: FeatureData.CATEGORIES.SVT210A,
  [DeviceType.SVT210S]: FeatureData.CATEGORIES.SVT220S1S3,
  [DeviceType.SVT220S1]: FeatureData.CATEGORIES.SVT220S1S3,
  [DeviceType.SVT220S3]: FeatureData.CATEGORIES.SVT220S1S3,
  [DeviceType.SVT510L]: FeatureData.CATEGORIES.SVT220S1S3,
  [DeviceType.SVT210SU]: FeatureData.CATEGORIES.SVT210SU,
  [DeviceType.ST100]: FeatureData.CATEGORIES.ST,
  [DeviceType.ST101S]: FeatureData.CATEGORIES.ST,
  [DeviceType.ST101L]: FeatureData.CATEGORIES.ST,
  [DeviceType.OilFiller]: FeatureData.CATEGORIES.OilFiller,
  [DeviceType.SPT510]: FeatureData.CATEGORIES.SPT,
  [DeviceType.SQ100]: FeatureData.CATEGORIES.SQ,
  [DeviceType.SQ110C]: FeatureData.CATEGORIES.SQ
};
