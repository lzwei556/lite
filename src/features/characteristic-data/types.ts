import { Axis, CharacteristicData } from 'common';
...
export type CharacteristicDataDTO = {
  timestamp: number;
  values: Property[];
}[];
...
export type Waveform = {
  dataType: DataType;
  meta?: readonly CharacteristicData.DisplayProperty[];
  properties: WaveformProperty[];
  xAxis?: CharacteristicData.DisplayProperty;
};
