...
import { FormItemsProps } from './common';

export const WsnFormItems = ({
  mode: modeFromProps,
  formItemColProps
}: { mode?: NetworkProvisioningMode } & Omit<FormItemsProps, 'settings'>) => {
  const [mode, setMode] = React.useState<NetworkProvisioningMode>(
    modeFromProps ?? NetworkProvisioningMode.Mode2
  );
